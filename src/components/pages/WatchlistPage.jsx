  ...
  return (
    <div className="animate-fade-in">
      <div className="flex items-center gap-2 mb-6">
        ...
        <h1 className="font-display text-4xl text-white tracking-wider">WATCHLIST</h1>
        <span className="ml-2 px-2.5 py-0.5 bg-brand-500/20 text-brand-400 text-sm font-mono rounded-lg">
          {watchlist.length}
        </span>
      </div>
      ...
      {watchlist.length === 0 ? (
        <div className="glass rounded-3xl p-16 text-center">
          <Bookmark size={64} className="mx-auto text-white/10 mb-4" />
          <p className="font-display text-3xl text-white/30 tracking-wider">YOUR LIST IS EMPTY</p>
          <p className="text-white/20 text-sm mt-2">Browse movies and TV shows and hit "Watch" to save them here</p>
        </div>
      ) : (
        <>
          {/* Controls */}
